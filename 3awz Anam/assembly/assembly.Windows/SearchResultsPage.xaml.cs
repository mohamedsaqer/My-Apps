...
namespace assembly
{
    ...
    public sealed partial class SearchResultsPage : Page
    {
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            nm=new Data ();
            nm.Data_in();
            var SearchQuery = e.NavigationParameter.ToString().ToUpper();
            var ProblemsSearchResult = (from x in nm.mylist where x.Name.Contains(SearchQuery) select x).ToList<hotel>();
            showlist.ItemsSource = ProblemsSearchResult;
        }
